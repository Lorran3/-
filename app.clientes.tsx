    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-4 -mt-14 relative z-10 space-y-3">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="rounded-2xl bg-card border border-border shadow-card p-3">
            <div className="h-9 w-9 rounded-xl bg-amber-500/15 text-amber-700 flex items-center justify-center mb-2">
              <Sparkles className="h-4 w-4" />
            </div>
            <p className="text-[10px] uppercase tracking-wider font-bold text-muted-foreground">Iniciantes</p>
            <p className="font-display text-2xl leading-tight">{clientes.filter(c => c.nivel === "iniciante").length}</p>
          </div>
          <div className="rounded-2xl bg-card border border-border shadow-card p-3">
            <div className="h-9 w-9 rounded-xl bg-sky-500/15 text-sky-700 flex items-center justify-center mb-2">
              <Zap className="h-4 w-4" />
            </div>
            <p className="text-[10px] uppercase tracking-wider font-bold text-muted-foreground">Intermediários</p>
            <p className="font-display text-2xl leading-tight">{clientes.filter(c => c.nivel === "intermediario").length}</p>
          </div>
          <div className="rounded-2xl bg-card border border-border shadow-card p-3">
            <div className="h-9 w-9 rounded-xl bg-violet-500/15 text-violet-700 flex items-center justify-center mb-2">
              <Trophy className="h-4 w-4" />
            </div>
            <p className="text-[10px] uppercase tracking-wider font-bold text-muted-foreground">Avançados</p>
            <p className="font-display text-2xl leading-tight">{clientes.filter(c => c.nivel === "avancado").length}</p>
          </div>
        </div>
